...
public class DatabaseAccessFavourite {
    String table = "giohang";
    private Context context;
    private SQLiteOpenHelper openHelper;
    private SQLiteDatabase database;
    private static DatabaseAccessFavourite instance;
     ...
     * @param context
     */
    private DatabaseAccessFavourite(Context context) {
     ...
     */
    public static DatabaseAccessFavourite getInstance(Context context) {
        if (instance == null) {
            instance = new DatabaseAccessFavourite(context);
        }
        return instance;
    }
